...
No! Dosezy is **100% local-first and offline**. You do not need to register an account, log in, or have an internet connection. All your medicines, schedules, and adherence logs stay privately stored directly on your phone in an offline database.
...
## 🔔 Reliability Shield & Notification Troubleshooting

### What is the green shield icon at the top of the screen?
The shield on the top bar is the **Notification Reliability Status** button. It stays accessible on every main screen and subpage. Tapping it opens a live system diagnostic checklist:
- **Exact Alarms**: Checks if Android allows precision alarms to wake your device on time.
- **Notifications**: Checks if notifications are permitted.
- **Battery Optimization**: Checks if background power restrictions are disabled so Android does not sleep Dosezy when your screen is turned off.

If any system setting is preventing alarms, the shield displays a warning color and provides 1-tap links directly to your device settings (including manufacturer-specific guides for Samsung, Xiaomi, etc.).
...
4. Each family profile manages its own private list of emergency contacts, keeping personal doctor numbers isolated between household members.
...
Contact support from **Menu > More > Help & Support** inside the app or email **reach.saad@outlook.com**.
